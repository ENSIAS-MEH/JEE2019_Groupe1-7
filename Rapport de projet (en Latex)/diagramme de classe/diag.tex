...
\begin{class}[text width=4cm]{Panier}{0,-8.5} 
\attribute{panierProduitPK :PanierProduitPK} 
\attribute{quantite: int} 
\attribute{produit: Produit} 
\attribute{panier: Panier} 




\operation{PanierProduit(): void} 
\operation{PanierProduit(PanierProduitPK ) : void}
\operation{PanierProduit(String, int  ) : void}
\operation{getPanierProduitPK()  : PanierProduitPK} 
\operation{setPanierProduitPK(PanierProduitPK) : void} 
\operation{getQuantite() : int} 
\operation{setQuantite(Int) : void} 
\operation{getProduit() : Produit}
\operation{setProduit(Produit) : void} 
\operation{getPanier()  : Panier} 
\operation{setPanier(Panier) : void} 



\end{class} 

\begin{class}[text width=4cm]{Panier}{5,-8.5} 
...
\operation{PanierProduitPK(): void} 
\operation{PanierProduitPK(String, int ) : void}
\operation{getModel() : string}
 
\operation{setModel(String) : void} 
\operation{getIdPanier() : int} 
\operation{setIdPanier(int) : void} 
...
\begin{class}[text width=4cm]{Produit}{11,-8.5} 
...
\attribute{panierProduitCollection:Collection} 
\attribute{produitCommandeCouleurCollection:Collection} 
